...
/*
 -- The next few lines tell the browser to hide the sections of the layout if the
 -- corresponding classes containing the data to be displayed is not available
 */
